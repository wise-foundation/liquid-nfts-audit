...
contract LiquidHelper is LiquidBase {
        ...
        returns (bool)
    {
        unchecked {
            return
                nextDueTime > 0 &&
                nextDueTime + DEADLINE_TIME < block.timestamp;
        }
    }
    ...
    /**
     * @dev sets locker owner to zero address
     */
    function _revokeOwner()
        internal
    {
